...
<!--        />-->
        ...
        <div id="flux" class="form-group">
          ...
          <p class="content" style="font-size:16px;line-height: 1.5rem;margin-top:10px;">
            ...
            1.4閣下必須提供某些個人資料(在收集個人資料時會列明)。假如閣下未能提供任何被列明為「必須」的個人資料或提供不真實或不完整的資料，我們有可能無法處理任何會籍申請或任何由閣下提出的要求，而我們亦保留拒絕向閣下提供「King's」產品或服務的權利，當中包括拒絕閣下的會籍申請。
            1.5所有個人資料將會在自願、公開及公平的基礎上收集。
            1.6所有收集的資料只供內部使用。
            <br>
            2. 收集個人資料的目的<br>
            「King's」將會收集閣下的個人資料作下列用途：
            2.1 處理閣下的會籍申請，維持及管理閣下的會員帳戶；
            2.2 確認閣下身份
            2.3 提供由「King's」及/或我們所聘用的、協助我們向閣下提供服務的服務供應商的銷售服務，或任何計劃或活動的獎賞、生日優惠、電子禮券及服務；
            ...
            2.8 組成「King's」運作所需的顧客資料庫的一部分；及/或
            ...
            <br>
            4. 準確性<br>
            「King's」會採取所有切實可行的步驟以確保所收集的個人資料均為準確。
            「King's」歡迎閣下在登記「King's」的服務時提供準確的個人資料及在資料變更時通知「King's」以作及時更新。
            <br>
            5. 查閱及改正<br>
            5.1閣下有權知道:
            5.1.1. 「King's」的私隱政策
            5.1.2. 「King's」是否持有閣下任何的個人資料；及
            5.1.3. 「King's」持有個人資料的種類。
            ...
            * 建立網上顧客或訪客的簡介。
            ...
            King's Cargo Logistics Limited之客戶服務主任
